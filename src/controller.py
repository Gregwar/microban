...
class ControllerProtocol(Protocol):
    ...
    # Stamped into every log's metadata block: at minimum {"source": ...} saying whether the
    # samples come from the real robot or from a simulator, plus whatever else identifies the
    # setup (the MuJoCo controller adds the bam actuator model it runs).
